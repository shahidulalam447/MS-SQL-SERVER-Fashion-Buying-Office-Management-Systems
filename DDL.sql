...
/*                  
					...
					SQL Project Name : Fashion Buying Office Management Systems (FBOMS)
            		    Trainee Name : MD SHAHIDUL ALAM                      
					      Trainee ID : 1272289							          
...
USE master
GO
DROP DATABASE IF EXISTS FBOMS_DB
GO

CREATE DATABASE FBOMS_DB
ON
(
	NAME='FBOMS_DB_DATA_1',
	FILENAME='C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\FBOMS_DB_DATA_1.mdf',
	SIZE=50MB,
	MAXSIZE=100MB,
	FILEGROWTH=5%
)
...
(
NAME='FBOMS_DB_LOG_1',
	FILENAME='C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\FBOMS_DB_LOG_1.ldf',
	SIZE=5MB,
	MAXSIZE=50MB,
	FILEGROWTH=1MB
)
